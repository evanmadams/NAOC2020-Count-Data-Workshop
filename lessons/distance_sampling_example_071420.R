...
#then we pull all the distance classes of our CHSP observation and the site that they below to
...
breaks <- c(0, 100, 200, 300, 400, 500) #create distance breaks to divid the observations
